...
function addDefaultPrice(field, price) {
    field.innerText = '0';
    let subTotalText = subTotalField.innerText;
    let subTotalFloat = parseFloat(subTotalText);
    subTotalField.innerText = subTotalFloat - price;
}
...
defaultMemoryPrice.addEventListener('click', function () {
    addDefaultPrice(memeoryPriceField, 100);
});
